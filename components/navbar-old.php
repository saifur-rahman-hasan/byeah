            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="#">Multi Link <span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                ...
                <li>
                    <a href="#">
                        <i class="fa fa-thermometer-full fa-fw"></i> Business Plan Tabs <span class="fa arrow"></span>
                    </a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#">Link #</a>
